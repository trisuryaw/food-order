        ...
        <LoginRegisterLayout title="Register">
            <form>
                <div className="flex flex-col gap-y-7">
                    ...
                    <InputPasswordWithLabel label="Kata Sandi" placeholder="Kata Sandi" />
                    <InputPasswordWithLabel label="Konfirmasi Kata Sandi" placeholder="Konfirmasi Kata Sandi" />

                    <Button type="submit" variant="success">Register</Button>

                    <Link to="/" className="ml-1 text-success text-center">Batal, Kembali ke Halaman Login</Link>
                </div>
            </form>
        </LoginRegisterLayout>
    </>
